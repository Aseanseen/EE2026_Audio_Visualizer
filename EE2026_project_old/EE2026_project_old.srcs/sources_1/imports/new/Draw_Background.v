...
// Please modify below codes to change the background color and to display ticks defined above
    assign VGA_Red_Grid = (Condition_For_Axes || Condition_For_Ticks || Condition_For_Grid || Condition_For_SmallT)  ? 4'h0 : 4'h0 ;
    assign VGA_Green_Grid = (Condition_For_Axes || Condition_For_Ticks || Condition_For_Grid || Condition_For_SmallT) ? 4'hD : 4'h0 ;
    assign VGA_Blue_Grid = (Condition_For_Axes || Condition_For_Ticks || Condition_For_Grid || Condition_For_SmallT) ? 4'h0 : 4'h0 ;
