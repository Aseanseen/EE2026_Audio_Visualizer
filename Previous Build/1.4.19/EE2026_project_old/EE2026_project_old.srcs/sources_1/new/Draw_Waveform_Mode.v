...
module Draw_Waveform_Mode(
    ...
    assign VGA_Red_waveform = ((VGA_HORZ_COORD < 1280) && 
    ((waveformstate == 0 && VGA_VERT_COORD == (1024 - Sample_Memory[VGA_HORZ_COORD]))
    
    || (waveformstate == 1 && (Sample_Memory[VGA_HORZ_COORD] >= 512 ? 
    (VGA_VERT_COORD <= 512 && VGA_VERT_COORD >= (1024 - Sample_Memory[VGA_HORZ_COORD])) :
    (VGA_VERT_COORD >= 512 && VGA_VERT_COORD <= (1024 - Sample_Memory[VGA_HORZ_COORD])) ))
    
    || (waveformstate == 2 && VGA_VERT_COORD <= 512 && VGA_VERT_COORD >= (1024 - Sample_Memory[VGA_HORZ_COORD])))) ? red : 0;
    
    assign VGA_Green_waveform = ((VGA_HORZ_COORD < 1280) && 
    ((waveformstate == 0 && VGA_VERT_COORD == (1024 - Sample_Memory[VGA_HORZ_COORD]))
    ...
    || (waveformstate == 2 && VGA_VERT_COORD <= 512 && VGA_VERT_COORD >= (1024 - Sample_Memory[VGA_HORZ_COORD])))) ? green : 0;
    
    assign VGA_Blue_waveform = ((VGA_HORZ_COORD < 1280) && 
    ((waveformstate == 0 && VGA_VERT_COORD == (1024 - Sample_Memory[VGA_HORZ_COORD]))
    ...
    || (waveformstate == 2 && VGA_VERT_COORD <= 512 && VGA_VERT_COORD >= (1024 - Sample_Memory[VGA_HORZ_COORD])))) ? blue : 0;
